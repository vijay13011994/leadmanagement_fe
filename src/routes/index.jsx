...
import UserTaskTable from "../pages/task/table/UserTaskTable";
...
const pages = [{key:'dashboard', value:Dashboard},
                {key:'lead', value:Lead},
                {key:'opprourtinity', value:Opprourtinity},
                {key:'product', value:Product},
                {key:'productmapping', value:ProductMapping},
                {key:'task', value:Task},
                {key:'user', value: User},
                {key:'lead/:id', value: EditLead},
                {key:'opprourtinity/:id', value: EditOppourtinity},
                {key:'account', value: Account},
                {key:'account/:id', value: EditAccount},
                {key:'contact/:id', value: EditContact},
                {key:'unassigned', value: UnassignedLeads},
                {key:'task/list', value: UserTaskTable}
            ];
